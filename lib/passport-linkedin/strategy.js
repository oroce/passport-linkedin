...
function Strategy(options, verify) {
  ...
  this.userParams = options.userParams || "id,first-name,last-name";
...
Strategy.prototype.userProfile = function(token, tokenSecret, params, done) {
  this._oauth.get('https://api.linkedin.com/v1/people/~:('+ this.userParams +')?format=json', token, tokenSecret, function (err, body, res) {
